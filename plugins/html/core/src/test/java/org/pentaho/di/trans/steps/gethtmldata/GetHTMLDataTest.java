 ...
 */
public class GetHTMLDataTest extends TestCase {
    ...
    public void testGetXMLDataSimple1() throws Exception {
        ...
        transMeta.setName("GetHTMLdata1");
        ...
        GetHTMLDataMeta gxdm = new GetHTMLDataMeta();
        ...
        GetHTMLDataField[] fields = new GetHTMLDataField[5];

        for (int idx = 0; idx < fields.length; idx++) {
            fields[idx] = new GetHTMLDataField();
        }

        fields[0].setName("objectid");
        fields[0].setXPath("ObjectID");
        fields[0].setElementType(GetHTMLDataField.ELEMENT_TYPE_NODE);
        ...
        fields[0].setTrimType(GetHTMLDataField.TYPE_TRIM_NONE);

        fields[1].setName("sapident");
        fields[1].setXPath("SAPIDENT");
        fields[1].setElementType(GetHTMLDataField.ELEMENT_TYPE_NODE);
        ...
        fields[1].setTrimType(GetHTMLDataField.TYPE_TRIM_NONE);

        fields[2].setName("quantity");
        fields[2].setXPath("Quantity");
        fields[2].setElementType(GetHTMLDataField.ELEMENT_TYPE_NODE);
        ...
        fields[2].setTrimType(GetHTMLDataField.TYPE_TRIM_NONE);

        fields[3].setName("merkmalname");
        fields[3].setXPath("Merkmalname");
        fields[3].setElementType(GetHTMLDataField.ELEMENT_TYPE_NODE);
        ...
        fields[3].setTrimType(GetHTMLDataField.TYPE_TRIM_NONE);

        fields[4].setName("merkmalswert");
        fields[4].setXPath("Merkmalswert");
        fields[4].setElementType(GetHTMLDataField.ELEMENT_TYPE_NODE);
        ...
        fields[4].setTrimType(GetHTMLDataField.TYPE_TRIM_NONE);
    ...
    public void testInit() throws Exception {
        ...
        GetHTMLDataData getHTMLDataData = new GetHTMLDataData();
        GetHTMLData getHTMLData = new GetHTMLData(dummyStep1, getHTMLDataData, 0, transMeta, trans);
        getHTMLData.setVariable("xml_path", "data/owner");
        getHTMLData.init(gxdm, getHTMLDataData);
