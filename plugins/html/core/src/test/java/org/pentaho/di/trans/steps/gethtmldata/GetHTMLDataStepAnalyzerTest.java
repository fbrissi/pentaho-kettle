...
public class GetHTMLDataStepAnalyzerTest {

    GetHTMLDataStepAnalyzer analyzer;

    @Mock
    GetHTMLDataMeta meta;
    @Mock
    ...
    public void setUp() throws Exception {
        ...
        analyzer = spy(new GetHTMLDataStepAnalyzer());
    ...
    public void testGetSupportedSteps() {
        GetHTMLDataStepAnalyzer analyzer = new GetHTMLDataStepAnalyzer();
        Set<Class<? extends BaseStepMeta>> types = analyzer.getSupportedSteps();
        assertNotNull(types);
        assertEquals(types.size(), 1);
        assertTrue(types.contains(GetHTMLDataMeta.class));
    }
    ...
    public void testCreateOutputFieldNode() throws Exception {
        ...
        GetHTMLDataField[] fields = new GetHTMLDataField[2];
        GetHTMLDataField field1 = new GetHTMLDataField("name");
        GetHTMLDataField field2 = new GetHTMLDataField("age");
    ...
    public void testGetXMLDataExternalResourceConsumer() throws Exception {
        GetHTMLDataExternalResourceConsumer consumer = new GetHTMLDataExternalResourceConsumer();
        ...
        assertEquals(GetHTMLDataMeta.class, consumer.getMetaClass());
    }
