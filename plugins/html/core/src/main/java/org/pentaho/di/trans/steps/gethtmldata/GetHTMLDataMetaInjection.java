 ...
 * @since 01-11-2017
 */
public class GetHTMLDataMetaInjection extends BaseStepMetaInjection implements StepMetaInjectionInterface {

    private GetHTMLDataMeta meta;

    public GetHTMLDataMetaInjection(GetHTMLDataMeta meta) {
        this.meta = meta;
    }
    ...
    public void injectStepMetadataEntries(List<StepInjectionMetaEntry> all) throws KettleException {
        ...
        List<GetHTMLDataMetaInjection.FilenameLine> filenameLines = new ArrayList<GetHTMLDataMetaInjection.FilenameLine>();
        List<GetHTMLDataField> fields = new ArrayList<GetHTMLDataField>();
                                        ...
                                        if (metaEntry != null) {
                                            ...
                                            switch (metaEntry) {
                                                ...
                                                case INPUTFIELD_ELEMENT_TYPE:
                                                    field.setElementType(GetHTMLDataField.getElementTypeByCode(value));
                                                    break;
                                                case INPUTFIELD_RESULT_TYPE:
                                                    field.setResultType(GetHTMLDataField.getResultTypeByCode(value));
                                                    break;
        ...
        //
        if (fields.size() > 0) {
            meta.setInputFields(fields.toArray(new GetHTMLDataField[fields.size()]));
        }
    ...
    public GetHTMLDataMeta getMeta() {
        return meta;
    }
