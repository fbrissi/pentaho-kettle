...
/**
 * Describes an HTML field and the position in an HTML field.
 *
 * @author Filipe Bojikian Rissi
 * @since 01-11-2017
 */
public class GetHTMLDataField implements Cloneable {
    ...
    public static final String[] ResultTypeDesc = {BaseMessages.getString(PKG, "GetHTMLDataField.ResultType.ValueOf"),
            BaseMessages.getString(PKG, "GetHTMLDataField.ResultType.SingleNode")};
    ...
    public static final String[] trimTypeDesc = {BaseMessages.getString(PKG, "GetHTMLDataField.TrimType.None"),
            BaseMessages.getString(PKG, "GetHTMLDataField.TrimType.Left"),
            BaseMessages.getString(PKG, "GetHTMLDataField.TrimType.Right"),
            BaseMessages.getString(PKG, "GetHTMLDataField.TrimType.Both")};
    ...
    public static final String[] ElementTypeDesc = {BaseMessages.getString(PKG, "GetHTMLDataField.ElementType.Node"),
            BaseMessages.getString(PKG, "GetHTMLDataField.ElementType.Attribute")};
    ...
    public GetHTMLDataField(String fieldname) {
        this.name = fieldname;
        this.xpath = "";
        this.length = -1;
    ...
    public GetHTMLDataField(Node fnode) throws KettleValueException {
    ...
    public Object clone() {
        try {
            GetHTMLDataField retval = (GetHTMLDataField) super.clone();
