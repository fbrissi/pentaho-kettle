 ...
 * @since 01-11-2017
 */
@Step(id = "getHTMLData", image = "GXD.svg", i18nPackageName = "org.pentaho.di.trans.steps.gethtmldata",
        name = "GetHTMLData.name", description = "GetHTMLData.description", categoryDescription = "GetHTMLData.category",
        documentationUrl = "http://wiki.pentaho.com/display/EAI/Get+Data+From+HTML")
public class GetHTMLDataMeta extends BaseStepMeta implements StepMetaInterface {
     ...
     */
    private GetHTMLDataField[] inputFields;
     ...
     */
    public GetHTMLDataField[] getInputFields() {
        return inputFields;
    }
     ...
     */
    public void setInputFields(GetHTMLDataField[] inputFields) {
    ...
    public Object clone() {
        GetHTMLDataMeta retval = (GetHTMLDataMeta) super.clone();
        ...
        for (int i = 0; i < nrFields; i++) {
            if (inputFields[i] != null) {
                retval.inputFields[i] = (GetHTMLDataField) inputFields[i].clone();
            }
        }
        return retval;
    }
    ...
    public String getXML() {
        ...
        for (int i = 0; i < inputFields.length; i++) {
            GetHTMLDataField field = inputFields[i];
    ...
    private void readData(Node stepnode) throws KettleXMLException {
        try {
            ...
            for (int i = 0; i < nrFields; i++) {
                ...
                GetHTMLDataField field = new GetHTMLDataField(fnode);
                inputFields[i] = field;
            }
            ...
            throw new KettleXMLException(BaseMessages.getString(PKG, "GetHTMLDataMeta.Exception.ErrorLoadingXML", e
                    .toString()));
        }
    }
    ...
    public void allocate(int nrfiles, int nrfields) {
        ...
        inputFields = new GetHTMLDataField[nrfields];
    }
    ...
    public void setDefault() {
        ...
        for (int i = 0; i < nrFields; i++) {
            inputFields[i] = new GetHTMLDataField("field" + (i + 1));
        }
    ...
    public void readRep(Repository rep, IMetaStore metaStore, ObjectId id_step, List<DatabaseMeta> databases)
        ...
        try {
            ...
            for (int i = 0; i < nrFields; i++) {
                ...
                field.setElementType(GetHTMLDataField.getElementTypeByCode(rep.getStepAttributeString(id_step, i,
                        "element_type")));
                field.setResultType(GetHTMLDataField.getResultTypeByCode(rep
                ...
                field.setTrimType(GetHTMLDataField.getTrimTypeByCode(rep
            ...
            throw new KettleException(BaseMessages.getString(PKG, "GetHTMLDataMeta.Exception.ErrorReadingRepository"), e);
        }
    }
    ...
    public void saveRep(Repository rep, IMetaStore metaStore, ObjectId id_transformation, ObjectId id_step)
        ...
        try {
            ...
            throw new KettleException(BaseMessages.getString(PKG, "GetHTMLDataMeta.Exception.ErrorSavingToRepository", ""
                    + id_step), e);
        }
    }
    ...
    public void check(List<CheckResultInterface> remarks, TransMeta transMeta, StepMeta stepMeta, RowMetaInterface prev,
        ...
        if (input.length <= 0) {
            cr =
                    new CheckResult(CheckResult.TYPE_RESULT_ERROR, BaseMessages.getString(PKG,
                            "GetHTMLDataMeta.CheckResult.NoInputExpected"), stepMeta);
            remarks.add(cr);
        } else {
            cr =
                    new CheckResult(CheckResult.TYPE_RESULT_OK, BaseMessages.getString(PKG,
                            "GetHTMLDataMeta.CheckResult.NoInput"), stepMeta);
            remarks.add(cr);
        }
        ...
        if (getLoopXPath() == null || Utils.isEmpty(getLoopXPath())) {
            cr =
                    new CheckResult(CheckResult.TYPE_RESULT_ERROR, BaseMessages.getString(PKG,
                            "GetHTMLDataMeta.CheckResult.NoLoopXpath"), stepMeta);
            remarks.add(cr);
        }
        if (getInputFields().length <= 0) {
            cr =
                    new CheckResult(CheckResult.TYPE_RESULT_ERROR, BaseMessages.getString(PKG,
                            "GetHTMLDataMeta.CheckResult.NoInputField"), stepMeta);
            remarks.add(cr);
        }
        ...
        if (isInFields()) {
            if (Utils.isEmpty(getXMLField())) {
                cr =
                        new CheckResult(CheckResult.TYPE_RESULT_ERROR, BaseMessages.getString(PKG,
                                "GetHTMLDataMeta.CheckResult.NoField"), stepMeta);
                remarks.add(cr);
            } else {
                cr =
                        new CheckResult(CheckResult.TYPE_RESULT_OK, BaseMessages.getString(PKG,
                                "GetHTMLDataMeta.CheckResult.FieldOk"), stepMeta);
                remarks.add(cr);
            }
        } else {
            ...
            if (fileInputList == null || fileInputList.getFiles().size() == 0) {
                cr =
                        new CheckResult(CheckResult.TYPE_RESULT_ERROR, BaseMessages.getString(PKG,
                                "GetHTMLDataMeta.CheckResult.NoFiles"), stepMeta);
                remarks.add(cr);
            } else {
                cr =
                        new CheckResult(CheckResult.TYPE_RESULT_OK, BaseMessages.getString(PKG,
                                "GetHTMLDataMeta.CheckResult.FilesOk", "" + fileInputList.getFiles().size()), stepMeta);
                remarks.add(cr);
            }
        }
    }
    ...
    public StepInterface getStep(StepMeta stepMeta, StepDataInterface stepDataInterface, int cnr, TransMeta tr,
                                 Trans trans) {
        return new GetHTMLData(stepMeta, stepDataInterface, cnr, tr, trans);
    }

    public StepDataInterface getStepData() {
        return new GetHTMLDataData();
    }
    ...
    public StepMetaInjectionInterface getStepMetaInjectionInterface() {
        return new GetHTMLDataMetaInjection(this);
    }
